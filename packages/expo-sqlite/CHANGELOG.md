...
- 8d6374b: Expose `SqliteRepositories` as the primary Expo SQLite repository entry point while keeping
  `ExpoSqliteRepositories` as a migration alias.
...
- Legacy changelog: `../../history/changelogs/legacy/expo-sqlite.md`
